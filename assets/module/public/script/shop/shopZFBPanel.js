glGame.baseclass.extend({
    ...
    refPayData(payKey) {
        ...
        this.type = this.payData.type;              //1官网充值 2在线
    ...
    commitEnd() {
        let alipayName = this.alipayName.string;
        let orderNum = this.order.string;
        if (!alipayName || !orderNum) {
        ...
        console.log("最终提交", alipayName, orderNum)
    },
